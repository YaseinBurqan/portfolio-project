      ...
      <section className="inner-footer">
        <div className="top-footer">
          <div className="footer-contact">
            <h3>Contact</h3>
            <p>
              Let's connect and get
              <br />
              your problem <span>solved with code.</span>
            </p>
            <div>
          ...
          <div className="footer-contact-info">
            ...
            <p>
              <i class="fa-sharp fa-solid fa-location-dot"></i> Jordan, Amman
            </p>
            <p>
              <i class="fa-solid fa-envelope"></i> mr.yasein@gmail.com
            </p>
            <p>
              <i class="fa-solid fa-phone"></i> +962799123681
            </p>
          </div>
        </div>
